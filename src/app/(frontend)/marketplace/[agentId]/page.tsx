...
export default async function AgentDetailPage(props: { params: Promise<{ agentId: string }> }) {
 ...
 <Link href="/marketplace" className="inline-flex items-center gap-2 text-[13px] font-medium text-slate-500 hover:text-teal-600 mb-10 transition-colors">
 ...
 <div className="grid h-20 w-20 sm:h-24 sm:w-24 flex-shrink-0 place-items-center rounded-2xl bg-teal-600 text-white shadow-sm shadow-teal-200">
 <Bot className="h-10 w-10 sm:h-12 sm:w-12" />
 </div>
 <div>
 <div className="flex flex-wrap items-center gap-2 mb-4">
 <span className="text-[11px] font-semibold text-teal-700 uppercase tracking-wider bg-teal-50 border border-teal-100 px-2.5 py-0.5 rounded">
 {agent.category || "Tool"}
 </span>
 ...
 <h1 className="text-3xl sm:text-4xl font-bold text-slate-800 tracking-tight leading-tight">{agent.name}</h1>
 ...
 <h3 className="text-lg font-semibold text-slate-800 mb-5">Features</h3>
 ...
 <div className="mb-6">
 <h3 className="text-lg font-semibold text-slate-800">Test Before You Buy</h3>
