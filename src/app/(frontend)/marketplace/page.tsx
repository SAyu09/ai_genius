...
export default async function MarketplacePage(props: { searchParams: Promise<{ q?: string; cat?: string; sort?: string; page?: string }> }) {
 ...
 <div>
 <div className="inline-flex items-center gap-2 text-[12px] font-bold text-teal-600 uppercase tracking-widest mb-4">
 <div className="h-1.5 w-1.5 rounded-full bg-teal-500 animate-pulse" />
 AI Agent Marketplace
 </div>
 <h1 className="text-4xl sm:text-[48px] font-bold text-slate-800 tracking-tight leading-[1.1]">
 ...
 className="group flex flex-col rounded-2xl border border-slate-200 bg-white overflow-hidden transition-all duration-200 hover:border-teal-200 hover:shadow-lg hover:shadow-teal-100/50"
 >
 ...
 <div className="h-10 w-10 shrink-0 rounded-xl bg-teal-600 flex items-center justify-center text-white text-[15px] font-bold shadow-sm shadow-teal-200">
