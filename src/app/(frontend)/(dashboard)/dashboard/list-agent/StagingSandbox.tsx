...
export function StagingSandbox({
 ...
 {/* Header */}
 <div className="flex items-center justify-between px-5 py-4 border-b border-border bg-gradient-to-r from-teal-50/80 to-emerald-50/80 dark:from-teal-950/30 dark:to-emerald-950/30">
 <div className="flex items-center gap-3">
 <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-teal-500 to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-teal-500/25">
 ...
 m.role === "user"
 ? "bg-gradient-to-br from-teal-500 to-emerald-600 text-white rounded-tr-md"
 ...
 <div className="h-8 w-8 rounded-full bg-teal-100 dark:bg-teal-900/40 text-teal-600 dark:text-teal-300 flex items-center justify-center shrink-0">
 <Bot className="h-4 w-4" />
 </div>
 ...
 type="submit"
 size="icon"
 className="rounded-xl h-11 w-11 shrink-0 bg-gradient-to-br from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 shadow-lg shadow-teal-500/20"
