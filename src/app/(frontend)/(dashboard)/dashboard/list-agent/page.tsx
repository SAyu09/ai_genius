...
export default function CreatorStudioPage() {
 ...
 className="rounded-xl px-6 bg-teal-600 hover:bg-teal-700 text-white"
 >
 ...
 <Button onClick={handlePublish} disabled={loading || !draftId} className="rounded-xl px-8 shadow-sm bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white transition-all hover:scale-[1.02]">
