...
export default async function SellerEarningsPage() {
 ...
 <div className="bg-teal-50 border border-teal-100 rounded-2xl p-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="h-10 w-10 bg-teal-100 rounded-full flex items-center justify-center text-teal-600 shrink-0">
 <Activity className="h-5 w-5" />
 </div>
 <div>
 <h3 className="text-sm font-bold text-teal-900">Actionable Insight: Optimization Opportunity</h3>
 <p className="text-xs text-teal-700">"Acme Sales Agent" has a 40% user drop-off at prompt #3. Consider simplifying the required inputs.</p>
 </div>
 </div>
 <Button variant="outline" className="shrink-0 bg-white border-teal-200 text-teal-700 hover:bg-teal-100">View Logs</Button>
 </div>
