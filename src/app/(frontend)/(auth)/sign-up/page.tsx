...
export default function SignUpPage() {
  ...
  const handleOAuth = async (provider: "google", role: "buyer" | "seller") => {
    setLoading(true);
    try {
      // Set cookie for intent
      document.cookie = `intended_role=${role}; path=/; max-age=3600`;
      
      const callbackUrl = role === "seller" ? "/api/auth/upgrade-role" : "/dashboard";
      ...
      <div className="flex flex-col justify-between p-6 sm:p-8 lg:p-12">
        ...
        <div className="mx-auto w-full max-w-sm py-12">
          ...
          <div className="space-y-3 mt-8">
            ...
            >
              {loading ? "Redirecting..." : "Register as User"}
            </Button>
            <Button 
            ...
            >
              {loading ? "Redirecting..." : "Register as Seller"}
            </Button>
          </div>
