...
function AuthContent() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-white">
      {/* ── LEFT: Showcase Panel ── */}
      <div className="relative hidden overflow-hidden lg:block bg-[var(--landing-bg)] border-r border-[var(--landing-border-light)]">
        {/* Glow effects */}
        <div
          aria-hidden
          className="absolute -right-32 -top-32 h-[480px] w-[480px] rounded-full bg-teal-100/50 blur-3xl pointer-events-none"
        />
        <div
          aria-hidden
          className="absolute -left-32 bottom-0 h-[420px] w-[420px] rounded-full bg-emerald-100/40 blur-3xl pointer-events-none"
        />
        {/* Grid pattern */}
        <div
          aria-hidden
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, var(--landing-accent-teal) 1px, transparent 1px), linear-gradient(to bottom, var(--landing-accent-teal) 1px, transparent 1px)",
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-gray-900">
          ...
          <Link href="/" className="flex items-center text-xl">
            ...
            />
            <span className="font-semibold tracking-tight text-[var(--landing-text-primary)]">AI Genius</span>
          </Link>
          ...
          <div className="relative my-8 grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={c.name}
                className={`flex items-center gap-3 rounded-2xl border border-gray-200/60 bg-white/60 p-3 backdrop-blur-md shadow-sm transition-transform duration-500 hover:scale-105 hover:shadow-md hover:border-teal-200 ${
              ...
              >
                ...
                <Zap className="ml-auto h-3.5 w-3.5 text-teal-400" />
              </div>
            ))}
          </div>
          ...
          {/* Social proof */}
          <div>
            <h2 className="text-3xl font-medium tracking-tight leading-tight sm:text-4xl text-[var(--landing-text-primary)]">
              Join 80,000+ teams deploying AI agents.
            </h2>
            <ul className="mt-6 grid grid-cols-2 gap-3 text-sm text-[var(--landing-text-secondary)] font-medium">
              {[
                "2,400+ vetted agents",
                "60+ currencies",
                "Deploy in 60s",
      ...
      <div className="flex flex-col justify-between p-6 sm:p-8 lg:p-12">
        {/* Mobile logo */}
        <Link href="/" className="flex items-center text-xl lg:hidden">
          <img
            src="/logo.png"
            alt="AI Genius Logo"
            className="h-16 w-16 object-cover -ml-3 -mr-4"
        ...
        <div className="mx-auto w-full max-w-sm py-8 lg:py-12">
          ...
          {activeTab === "signin" && (
            <div className="mt-8 animate-in fade-in slide-in-from-right-4 duration-300">
              <h1 className="text-3xl font-medium tracking-tight text-[var(--landing-text-primary)]">Welcome back.</h1>
              ...
              <form onSubmit={handleSignIn} className="mt-8 space-y-4">
                ...
                <Button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full h-12 rounded-xl bg-teal-600 text-white hover:bg-teal-700 font-semibold shadow-[0_4px_14px_rgba(13,148,136,0.35)] transition-all duration-300 hover:shadow-[0_6px_20px_rgba(13,148,136,0.45)] hover:-translate-y-px"
                  size="lg"
                >
                  {loading ? (
          ...
          {activeTab === "register" && (
            <div className="mt-8 animate-in fade-in slide-in-from-left-4 duration-300">
              <h1 className="text-3xl font-medium tracking-tight text-[var(--landing-text-primary)]">Create your account.</h1>
              <p className="mt-2 text-sm text-gray-500 font-medium">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  {regRole === "buyer" && (
                    <div className="absolute -right-2 -top-2 grid h-6 w-6 place-items-center rounded-full bg-teal-600 text-white shadow-sm border-2 border-white">
              ...
              <form onSubmit={handleRegister} className="mt-6 space-y-3">
                ...
                <Button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full h-12 mt-2 rounded-xl bg-teal-600 text-white hover:bg-teal-700 font-semibold shadow-[0_4px_14px_rgba(13,148,136,0.35)] transition-all duration-300 hover:shadow-[0_6px_20px_rgba(13,148,136,0.45)] hover:-translate-y-px"
                  size="lg"
                >
                  {loading ? (
                    <div className="flex items-center gap-2">
