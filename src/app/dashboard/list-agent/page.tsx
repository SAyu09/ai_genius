...
export default function ListAgentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("/api/sellers/agents", {
        method: "POST",
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="tag">Category Tag <span className="text-destructive">*</span></Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="price">One-time Price (USD) <span className="text-destructive">*</span></Label>
